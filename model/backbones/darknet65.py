...
class Darknet65(nn.Module):

    def __init__(self):
        super(Darknet65, self).__init__()
        ...
        self.__conv_5_0 = Convolutional(filters_in=32, filters_out=64, kernel_size=3, stride=2, pad=1, norm='bn',
                                        activate='leaky')
        self.__rb_5_0 = Residual_block(
            filters_in=64, filters_out=64, filters_medium=32)
        ...
        self.__rb_5_1_1 = Residual_block(
            filters_in=128, filters_out=128, filters_medium=64)
        self.__rb_5_1_2 = Residual_block(
            filters_in=128, filters_out=128, filters_medium=64)
        self.__rb_5_1_3 = Residual_block(
            filters_in=128, filters_out=128, filters_medium=64)
        ...
        self.__rb_5_4_3 = Residual_block(
            filters_in=1024, filters_out=1024, filters_medium=512)
        self.__rb_5_4_4 = Residual_block(
            filters_in=1024, filters_out=1024, filters_medium=512)
        self.__rb_5_4_5 = Residual_block(
            filters_in=1024, filters_out=1024, filters_medium=512)
        self.__rb_5_4_6 = Residual_block(
            filters_in=1024, filters_out=1024, filters_medium=512)
        self.__rb_5_4_7 = Residual_block(
            filters_in=1024, filters_out=1024, filters_medium=512)
    ...
    def forward(self, x):
        ...
        x1_3 = self.__rb_5_1_2(x1_2)
        x1_4 = self.__rb_5_1_3(x1_3)

        x2_0 = self.__conv_5_2(x1_4)
        ...
        x4_5 = self.__rb_5_4_4(x4_4)
        x4_6 = self.__rb_5_4_5(x4_5)
        x4_7 = self.__rb_5_4_6(x4_6)
        x4_8 = self.__rb_5_4_7(x4_7)  # large

        return x2_8, x3_8, x4_8
